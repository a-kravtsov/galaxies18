...
#from read_data import read_McConnachie12,read_Karachentsev13
from read_data import read_sdss_fits
...
ram, decm, dm, m = read_McConnachie12(data_home_dir()+'mcconnachie12.fits')
ram, decm, dm, m = read_Karachentsev13(data_home_dir()+'karachentsev13_BMag.txt')
